...
const DayEleven : React.FC<IDayElevenProps> = props => {
    ...
    <p>
        ...
        <Text english=" departing from Saint Florent. The round trip costs around 30€ per person depending on the beach you choose. Saleccia beach being further away, the ticket to access it is naturally more expensive. The trip from Saint Florent lasts about 20 minutes." french=" depuis Saint-Florent. L'aller-retour coûte environ 30€ par personne selon la plage que vous choisissez. La plage de Saleccia étant plus éloignée, le billet pour y accéder est naturellement plus cher. La traversée depuis Saint-Florent dure environ 20 minutes." />
        <br></br>
