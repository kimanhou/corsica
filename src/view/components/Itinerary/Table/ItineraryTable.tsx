        ...
        <div className={`table`}>
            <div className={`table-line`}>
                ...
                <div className={`days ${props.positionClassname}`}>
                    <TwoHalfDays AMenglish="Ajaccio" AMfrench="Ajaccio" AMimageSrc="./icons/village.png" PMenglish="Blood Islands - Parata Peninsula" PMfrench="Îles Sanguinaires - Pointe de la Parata" PMimageSrc="./icons/hike.png" />
                    ...
                    <TwoHalfDays AMenglish="Bonifacio" AMfrench="Bonifacio" AMimageSrc="./icons/village.png" PMenglish="Campu Rumanilu hike" PMfrench="Sentier de Campu Rumanilu" PMimageSrc="./icons/hike.png" />
                    ...
                    <FullDay english="Purcaraccia pools" french="Cascades de Purcaraccia" imageSrc="./icons/hike.png" />
                    <FullDay english="Restonica Valley" french="Vallée de la Restonica" imageSrc="./icons/hike.png" />
                </div>
            </div>
            ...
            <div className={`table-line`}>
                ...
                <div className={`days ${props.positionClassname}`}>
                    <FullDay english="Tavignano Gorge" french="Gorges du Tavignano" imageSrc="./icons/hike.png" />
                    ...
                    <TwoHalfDays AMenglish="Agriates Desert" AMfrench="Désert des Agriates" AMimageSrc="./icons/hike.png" PMenglish="Saint Florent Ile Rousse" PMfrench="Saint Florent Île Rousse" PMimageSrc="./icons/village.png" />
                    <TwoHalfDays AMenglish="Revellata Peninsula" AMfrench="Pointe de la Revellata" AMimageSrc="./icons/hike.png" PMenglish="Calvi" PMfrench="Calvi" PMimageSrc="./icons/village.png" />
                    ...
                    <TwoHalfDays AMenglish="Calanches de Piana" AMfrench="Calanches de Piana" AMimageSrc="./icons/hike.png" PMenglish="Road to Ajaccio" PMfrench="Route vers Ajaccio" PMimageSrc="./icons/car-no-border.png" />
                </div>
            </div>
        </div>
    );
