    ...
    return(
        <div className={`accommodation`}>
            ...
            <p>
                ...
                <br></br>
                <Text english="" french="Si vous êtes véhiculé, il est très avantageux de s'éloigner un peu des centres villes. Les logements en campagne ou dans des petits villages sont bien moins onéreux qu'en centre ville et vous pourrez ainsi profiter du calme et de la vie avec les locaux." />
                <br></br>
                <Text english="" french="Les régions les plus chères sont Calvi et Bonifacio - Porto Vecchio."/>
                <br></br><br></br>
                <Text english="During our two-week stay in September 2020, we booked all of our accommodations on Airbnb about a month in advance. 
                    ...
                    It is therefore imperative to have a French phone number and obviously speak French.
                    ...
                    Il faut donc impérativement avoir un numéro français et bien évidemment parler français. 
